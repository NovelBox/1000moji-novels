...
[note:オチ]
→イーカロスに使ったベースの少年は、自殺しようとしていたのではなく、亡くなった母親のところにいこうとして飛んだだけだった
...
[icarus:T]
うん
でも$ln_norikoさんには聞こえないから、やっぱり$meがおかしいのかな

[br]

[makishima:D]
$Sは研究棟の屋上から飛び出した際の、$icarusのカメラデータを解析していた
# が、やはりバグの疑いはない
...
[-:D]
$icarusは検診が終わった後、午前十時二十五分に病室を抜け出ている
この際にきっちりと監視モニタのコードを切り、ドアのアラームもハッキングで鳴らないように細工を施している
敵に拘束された時の脱出プログラムが正常に作動している証拠だ
# が、データ上は拘束されたという状態は記録されていなかった

[-:D]
見回りのスタッフをやり過ごし、研究棟の屋上へと階段を使って上がっている
# このルートは前回、前々回も同じだった為、
# 今回は
階段に設置した振動探知機によりこの動きは察知していた
...
[-:D]
空へと視線が固定されたまま落下し、十三階下の地面に衝突、そこで映像は途切れていた
!PE
